...
tinyMCE.init({
  ...
  content_css : "<?php echo TL_PATH; ?>/system/themes/tinymce.css,<?php echo TL_PATH .'/'. $this->uploadPath; ?>/tinymce_custom.css,<?php echo TL_PATH .'/'. $this->uploadPath; ?>/tinymce_defaults.css",
  ...
  //theme_advanced_buttons1 : "formatselect,bold,italic,underline,separator,anchor,separator,typolinks,unlink,separator,image,typobox,separator,bullist,numlist,indent,outdent,separator,blockquote,separator,sub,sup,separator,abbr,separator,undo,redo,separator,removeformat,cleanup,separator,code",
  theme_advanced_buttons1 : "formatselect,styleselect,bold,italic,underline,separator,justifyleft,justifycenter,justifyright,separator,anchor,separator,typolinks,unlink,separator,bullist,numlist,separator,blockquote,separator,sub,sup,separator,undo,redo,separator,removeformat,cleanup,separator,code",
